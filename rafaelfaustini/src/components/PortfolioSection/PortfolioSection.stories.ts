...
const Template = (args: any, { argTypes }: any) => ({
  ...
  template: '<PortfolioSection v-bind="$props"/>',
});
...
export const WithTitleButton : any = Template.bind({});
...
export const WithTitleButtonProject : any = Template.bind({});
WithTitleButtonProject.args = {
  ...WithTitleButton.args,
  projects: [
    {
      id: 1,
